...
<head>
  ...
  <meta name="description" content="Pagina web de participación nula">
  <meta name="author" content="Agustin y Ezequiel">
  <link rel="icon" href="favicon.ico">

  <title>Consejo-Web</title>
...
<body>
      ...
      <nav class="nav blog-nav">
        ...
        aria-haspopup="true" aria-expanded="false">Archivo</a>
          <div class="dropdown-menu" aria-labelledby="dropdownMenu1">
            ...
            <a class="dropdown-item" href="#">Abril 2017</a>
            <a class="dropdown-item" href="#">Mayo 2017</a>
        </div>
        </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col ">
          <h2 class="blog-post-title">Sesión 20/04/2017</h2>
    ...
    <tr>
      ...
      <div class="col-sm-3 blog-sidebar">
        <div class="sidebar-module sidebar-module-inset">
          ...
          <h3>Temas:</h3>
          <ul class="temas">
            <li><a href="">Introducción (0:00)</a> <a href="#comentar15m1s" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModal"><span class="badge badge-info">10</span> comentarios
            </a></li>

            <li><a href="">Seguridad (2:23)</a> <a href="#comentar15m1s" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModal"><span class="badge badge-info">2</span> comentarios
            </a></li>

            <li><a href="">Iluminacion (3:17)</a> <a href="#comentar15m1s" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModal"><span class="badge badge-info">1</span> comentarios
            </a></li>

            <li><a href="">Construcción de cloacas (5:00)</a> <a href="#comentar15m1s" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModal"><span class="badge badge-info">1</span> comentarios
            </a></li>
          </ul>
  ...
  <footer class="blog-footer";
    ...
    <p>20, mayo 2017 by <a href="#">Agustin y Ezequiel</a></p>
  </footer>
